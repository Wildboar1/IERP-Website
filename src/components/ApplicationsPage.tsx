	...
	return (
		<div className="min-h-screen w-full bg-gradient-to-br from-background to-[#1e293b] text-foreground flex flex-col">
			<main className="flex-1 flex flex-col justify-center items-center w-full">
				<div className="w-full max-w-7xl px-0 md:px-8 py-12">
					<div className="mb-8">
						<h1 className="mb-2 text-3xl font-bold text-center md:text-left">Department Applications</h1>
						<p className="text-muted-foreground text-center md:text-left">
							Apply to join one of our prestigious departments
						</p>
					</div>
										...
										<div className="text-center py-12">
											...
											<div className="bg-red-50 border border-red-200 rounded-lg p-4 max-w-md mx-auto">
												<p className="text-sm text-red-800">
													<strong>⚠️ Application Limit Reached</strong>
													<br />
												...
												<div className="space-y-2">
													...
													{user?.username && formData.discord === user.username && (
														<p className="text-xs text-green-600">
															✓ Auto-filled from your Discord profile
														</p>
													)}
												</div>
											</div>
												...
												<div className="space-y-4">
													<div>
														...
														<p className="text-sm text-muted-foreground">
															These questions are required for LSPD applications to ensure
															realistic police roleplay.
														</p>
													</div>
													...
													<div className="space-y-3">
														<div className="space-y-2">
															<Label htmlFor="lspd-motivation">
																Why do you want to join the police department in this roleplay
																server, and what makes your approach different from others?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-motivation"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-realistic">
																What does “realistic roleplay” mean to you? Give one example of
																good police RP and one example of bad police RP.{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-realistic"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-rude">
																If you stop a suspect who is being rude but not breaking any
																laws, how would you handle the situation in RP?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-rude"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-misconduct">
																You witness a fellow officer breaking server rules or
																power-gaming. What would you do?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-misconduct"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-noncompliant">
																A suspect refuses to cooperate during a traffic stop but is not
																violent. What steps would you take, and why?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-balance">
																How would you balance winning a situation versus maintaining
																realistic roleplay?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-abuse">
																What would you do if a civilian accuses you of abusing police
																power during an interaction?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-abuse"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-injury">
																Explain how you would roleplay being injured after a shootout,
																even if the game mechanics allow you to move freely.{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
																id="lspd-injury"
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-qualities">
																What are the most important qualities a police officer should
																have in roleplay, and which of those qualities do you
																personally bring?{" "}
																<span className="text-red-500">*</span>
															</Label>
															<Textarea
														...
														<div className="space-y-2">
															<Label htmlFor="lspd-mistake">
																If you make a mistake during RP that affects another player,
